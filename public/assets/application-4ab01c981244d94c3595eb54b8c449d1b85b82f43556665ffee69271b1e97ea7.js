...
(function() {
  ...
  popupCenter = function(linkUrl, width, height, name) {
    var left, separator, top, url, windowFeatures;
  ...
  $(function() {
    return $('a.popup').click(function(e) {
      e.preventDefault();
      return popupCenter($(this).attr('href'), $(this).attr('data-width'), $(this).attr('data-height'), 'authPopup');
    });
  });
...
(function() {
  $(function() {
    ...
    $('.chosen-single-deselect').chosen({
      width: '100%',
      allow_single_deselect: true
    });
    return $('.alert').delay(3000).hide(300);
  });
...
(function() {
  ...
  GeoLocation = (function() {
    ...
    GeoLocation.prototype.showPosition = function(position) {
      return $.getJSON("https://maps.googleapis.com/maps/api/geocode/json?latlng=" + position.coords.latitude + "," + position.coords.longitude + "&sensor=true", (function(_this) {
        return function(data) {
          if (_this.successCb) {
            return _this.successCb(_this.getCity(data));
          }
        };
      })(this));
    };

    GeoLocation.prototype.getCity = function(data) {
      var addressComponents, component, i, index, len, result, types;
      index = isENLocale ? 4 : 0;
...
(function() {
  $(function() {
    ...
    return $('.chosen-single-deselect').chosen({
      width: '100%',
      allow_single_deselect: true
    });
  });
...
(function() {
  $(function() {
    var geoLocation, keyword, noResults, reloadByCity, searchInput;
    ...
    $(".form-search").submit(function(e) {
      var categories, cities, getPathSignal, index, option, selectedVal, url;
      getPathSignal = function(url) {
        if (url.indexOf("?") > -1) {
          return "&";
        } else {
          return "?";
    ...
    reloadByCity = function(city) {
      ...
      return window.location.href = "/posts" + params;
    };
    $(".location-select .yes-btn").click(function(e) {
      var city;
      city = $(".location-select option:selected").text();
      localStorage.currentLocation = city;
      return reloadByCity(city);
    });
    $(".location-select .no-btn").click(function(e) {
      localStorage.deniedToLoadCurrentLocation = true;
      return $(".location-select").fadeOut();
    });
    if ((location.pathname === "/posts" || location.pathname === "/select_location") && (!localStorage.deniedToLoadCurrentLocation || localStorage.deniedToLoadCurrentLocation === "false")) {
      geoLocation = new GeoLocation((function(city) {
        if (typeof Storage !== "undefined" && city.longName !== localStorage.currentLocation) {
          $(".location-alert .city").text(city.longName);
          $(".location-alert .yes-btn").click(function(e) {
            localStorage.currentLocation = city.longName;
            return reloadByCity(city.longName);
          });
          $(".location-alert .no-btn").click(function(e) {
            return $(".location-alert").fadeOut(function() {
              if (!localStorage.currentLocation) {
                return $(".location-select").fadeIn();
              }
            });
          });
          return $(".location-alert").fadeIn();
        }
      }), (function() {
        return $(".location-select").fadeIn();
      }));
